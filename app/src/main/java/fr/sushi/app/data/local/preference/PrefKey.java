...
public interface PrefKey {
    ...
    String FIDELITY_GROUP = "FIDELITY_GROUP";
    String FIDELITY_AMOUNT = "FIDELITY_AMOUNT";
    String FIDELITY_IS_AVAILABLE = "FIDELITY_IS_AVAILABLE";
    String FIDELITY_TOTAL_QUANTITY = "FIDELITY_TOTAL_QUANTITY";
    String FIDELITY_QUANTITY = "FIDELITY_QUANTITY";
}
