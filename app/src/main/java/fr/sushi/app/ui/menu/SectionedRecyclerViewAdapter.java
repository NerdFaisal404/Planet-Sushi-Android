...
public class SectionedRecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public SectionedRecyclerViewAdapter(Context context, int sectionResourceId, int textResourceId, RecyclerView recyclerView,
    ...
    public void notifyPosChanged(int i) {
        // Toast.makeText(mContext, "" + mAdapter.getItem(pos).isSelected() + ":" + pos, Toast.LENGTH_LONG).show();


        notifyItemChanged(positionToSectionedPosition(i));
    }

    public void notifyPosDeleted(int i) {
        // Toast.makeText(mContext, "" + mAdapter.getItem(pos).isSelected() + ":" + pos, Toast.LENGTH_LONG).show();


        notifyItemRemoved(positionToSectionedPosition(i));
    }
